...
public class FacFactura extends BaseDomain implements Identifiable<Integer>, Serializable {
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this) //
                .add("id", getId()) //
                .add("serieFactura", getSerieFactura()) //
                .add("numeroFactura", getNumeroFactura()) //
                .add("mtrEstado", getMtrEstado()) //    
                .add("mtrProveedor", getMtrProveedor()) //    
                .add("mtrMoneda", getMtrMoneda()) //    
                .add("facContacto", getFacContacto()) //    
                .add("mtrDetraccion", getMtrDetraccion()) //    
                .add("tipoFactura", getTipoFactura()) //
                .add("tipoComprobanteFactura", getTipoComprobanteFactura()) //
                .add("monto", getMonto()) //
                .add("montoOtrosCargos", getMontoOtrosCargos()) //
                .add("montoIgv", getMontoIgv()) //
                .add("montoFinal", getMontoFinal()) //
                .add("glosa", getGlosa()) //
                .add("fechaFactura", getFechaFactura()) //
                .add("fechaEmision", getFechaEmision()) //
                .add("fechaCreacion", getFechaCreacion()) //
                .add("existeContrato", getExisteContrato()) //
                .add("estadoRetornoSunat", getEstadoRetornoSunat()) //
                .add("detalleServicio", getDetalleServicio()) //
                .add("indicadorConCertificado", getIndicadorConCertificado()) //
                .add("concepto", getConcepto()) //
                .add("codigoCorrelativoAdjunto", getCodigoCorrelativoAdjunto()) //
                .add("estado", getEstado()) //
                .add("mtrSociedad", getMtrSociedad()) //    
                .add("fechaEstimadaPago", getFechaEstimadaPago()) //
                .toString();
    }
}
